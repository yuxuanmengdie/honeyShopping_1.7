...
- (void)discoverRequest
{
    ...
    __weak typeof(self) wself = self;
    [self.httpRequestOperationManager POST:kGetDiscoverURL parameters:[HSPublic apiPostParas:parametersDic] success:^(AFHTTPRequestOperation *operation, id responseObject) {
...
- (void)isVIPWithUid:(NSString *)uid sessionCode:(NSString *)sessionCode
{
    ...
    [self.httpRequestOperationManager POST:kIsVIPURL parameters:[HSPublic apiPostParas:parametersDic] success:^(AFHTTPRequestOperation *operation, id responseObject) { /// 失败
