...
- (void)getCouponIdByCouponNoWithUid:(NSString *)uid sessionCode:(NSString *)sessionCode couponNo:(NSString *)couponNo
{
    ...
    [self.httpRequestOperationManager POST:kGetCouponIdByCouponNoURL parameters:[HSPublic apiPostParas:parametersDic] success:^(AFHTTPRequestOperation *operation, id responseObject) { /// 失败
...
- (void)couponRequestWithUid:(NSString *)uid sessionCode:(NSString *)sessionCode
{
    ...
    [self.httpRequestOperationManager POST:kGetCouponsByUidURL parameters:[HSPublic apiPostParas:parametersDic] success:^(AFHTTPRequestOperation *operation, id responseObject) { /// 失败
    } failure:^(AFHTTPRequestOperation *operation, NSError *error) {
        NSLog(@"%s failed\n%@",__func__,operation.responseString);
        if (operation.responseData == nil) {
...
- (void)getDefaultAddressWithUid:(NSString *)uid sessionCode:(NSString *)sessionCode
{
    ...
    [self.httpRequestOperationManager POST:kGetDefaultAddressURL parameters:[HSPublic apiPostParas:parametersDic] success:^(AFHTTPRequestOperation *operation, id responseObject) { /// 失败
        NSLog(@"success\n%@",operation.responseString);
...
- (void)getFreePriceRequestWithUid:(NSString *)uid num:(NSString *)num freetype:(NSString *)freetype sessionCode:(NSString *)sessionCode
{
    ...
    [_postageRequestOperation POST:kGetFreePriceURL parameters:[HSPublic apiPostParas:parametersDic] success:^(AFHTTPRequestOperation *operation, id responseObject) { /// 失败
        NSLog(@"success\n%@",operation.responseString);
...
- (void)addOrderWithUid:(NSString *)uid couponId:(NSString *)couponId username:(NSString *)username addressName:(NSString *)addressName mobile:(NSString *)mobile address:(NSString *)address supportmethod:(NSString *)supportmethod freetype:(NSString *)freetype sessionCode:(NSString *)sessionCode list:(NSArray *)list
{
    ...
    [self.httpRequestOperationManager POST:kAddOrderURL parameters:[HSPublic apiPostParas:parametersDic] success:^(AFHTTPRequestOperation *operation, id responseObject) { /// 失败
        NSLog(@"success\n%@",operation.responseString);
