...
- (void)getBannerImages
{
    ...
    [self.httpRequestOperationManager GET:kGetBannerURL parameters:[HSPublic apiPostParas:parametersDic] success:^(AFHTTPRequestOperation *operation, id responseObject) {
...
//    [self showNetLoadingView];
    NSDictionary *parametersDic = @{kPostJsonKey:[HSPublic md5Str:[HSPublic getIPAddress:YES]]};
    [self.httpRequestOperationManager POST:kGetIndexItemURL parameters:[HSPublic apiPostParas:parametersDic] success:^(AFHTTPRequestOperation *operation, id responseObject) { /// 失败
        [self hiddenMsg];
...
{
    NSDictionary *parametersDic = @{kPostJsonKey:[HSPublic md5Str:[HSPublic getIPAddress:YES]]};
    [self.httpRequestOperationManager POST:kGetCouponListURL parameters:[HSPublic apiPostParas:parametersDic] success:^(AFHTTPRequestOperation *operation, id responseObject) { /// 失败
...
- (void)blindCouponRequestWithUid:(NSString *)uid couponId:(NSString *)couponId sessionCode:(NSString *)sessionCode
{
    ...
    [self.httpRequestOperationManager POST:kBlindCouponWithUserURL parameters:[HSPublic apiPostParas:parametersDic] success:^(AFHTTPRequestOperation *operation, id responseObject) { /// 失败
