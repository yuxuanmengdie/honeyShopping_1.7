...
#pragma mark 请求url
/// 注册
#define kRegisterURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=User&a=register"]
/// 登录
#define kLoginURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=User&a=login"]
/// 第三方登陆接口(统一接口) weixin or qq
#define kOtherLoginURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=User&a=otherLogin"]
/// 第三方登录 /index.php?g=api_test&m=User&a=weixinLogin 微信
#define kWeixinLoginURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=User&a=weixinLogin"]
/// QQ 登录
#define kQqnLoginURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=User&a=qqnLogin"]
///获取手机验证码
#define kGetVerifyCodeURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=User&a=getVerifyCode"]
/// 验证手机验证码
#define kVerifyCodeURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=User&a=verifyCode"]
/// 密码设置 找回
#define kSetPasswordURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=User&a=setPassword"]
/// 用户信息
#define kGetUserInfoURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=User&a=getUserInfo"]
/// 个人信息更新
#define kUserInfoUpdateURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=User&a=userInfoUpdate"]
/// 签到
#define kSignURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=User&a=sign"]
/// 修改密码
#define kChangePassWordURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&mUser&a=changePassWord"]
/// 判断是否是会员
#define kIsVIPURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=User&a=isVIP"]


/// 收货地址
#define kGetAddressURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=User&a=getAddress"]
/// 收货地址更新  （新增收货地址不传id)
#define kAddressUpdateURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=User&a=addressUpdate"]
/// 获取默认收货地址
#define kGetDefaultAddressURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=User&a=getDefaultAddress"]
/// 设置默认收货地址
#define kSetDefaultAddressURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=User&a=setDefaultAddress"]
/// 删除收货地址
...
/// 商品信息
#define kGetItemByIdURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=Item&a=getItemById"]
/// 列表下的商品信息
#define kGetItemsByCateURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=Item&a=getItemsByCate"]
/// 列表下的广告商品信息
#define kGetAdsByCateURL [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=Item&a=getAdsByCate"]
/// 获取首页商品
#define kGetIndexItemURL [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=Item&a=getIndexItem"]


/// 获取收藏商品列表
#define kGetFavoriteURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=Item&a=getFavorite"]
/// 收藏
#define kAddFavoriteURL [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=Item&a=addFavorite"]
/// 删除收藏
#define kDelFavoriteURL [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=Item&a=delFavorite"]
/// 发现
#define kGetDiscoverURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=Item&a=getDiscover"]
/// 获取banner
#define kGetBannerURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=Item&a=getBanner"]


/// 获取用户订单列表(传status值则会根据status筛选) 1.代付款 2.待发货 3.待收获 4.完成 5。关闭
#define kGetOrderListURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=Order&a=getOrderList"]
/// 获取订单详情
#define kGetOrderDetailURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=Order&a=getOrderDetail"]
/// 生成订单（调取下个订单状态）
#define kAddOrderURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=Order&a=addOrder"]
/// 修改订单状态
#define kUpdateOrderNextURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=Order&a=updateOrderNext"]
/// 获取运费 freetype 0包邮1非包邮
#define kGetFreePriceURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=Order&a=getFreePrice"]

/// 获取首页优惠劵列表
#define kGetCouponListURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=Item&a=getCouponList"]
/// 获取用户优惠劵
#define kGetCouponsByUidURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=User&a=getCouponsByUid"]
/// 用户优惠劵
#define kGetCouponsByUidURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=User&a=getCouponsByUid"]
/// 领取优惠劵
#define kBlindCouponWithUserURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=User&a=blindCouponWithUser"]
/// 获取优惠劵ID by 优惠劵号 /index.php?g=api_test&m=Order&a=getCouponIdByCouponNo
#define kGetCouponIdByCouponNoURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=Order&a=getCouponIdByCouponNo"]

/// 获取微信支付perpayid
#define kGetWxPerpayidURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=Order&a=getWxPerpayid"]
/// 分享
#define kShareURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=Item&a=share"]
///获取引导图（advert目录）
#define kGetGuideURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=Item&a=getGuide"]
/// 获取欢迎图（advert目录）
#define kGetWelcomeURL  [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=Item&a=getWelcome"]

/// 评论
///商品评论(图片通过post传过来字段是"imgs[]")
#define kAddCommentURL [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=Order&a=addComment"]
///获取评论列表
#define kGetCommentByItemIdURL [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=Order&a=getCommentByItemId"]
/**
 * 带有图片的评论列表
 */
#define kGetCommentHasImgByItemIdURL [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=Order&a=getCommentHasImgByItemId"]
/**
 *  获取评论总信息
 */
#define kGetCommentInfoURL [NSString stringWithFormat:@"%@%@",kURLHeader,@"/index.php?g=api_test&m=Order&a=getCommentInfo"]
