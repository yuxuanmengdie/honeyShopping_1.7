...
- (void)orderRequestWithStatus:(int)status uid:(NSString *)uid sessionCode:(NSString *)sessionCode
{
    ...
    [self.httpRequestOperationManager POST:kGetOrderListURL parameters:[HSPublic apiPostParas:parametersDic] success:^(AFHTTPRequestOperation *operation, id responseObject) { /// 失败
