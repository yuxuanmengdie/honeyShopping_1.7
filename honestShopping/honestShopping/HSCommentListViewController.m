...
- (void)commentListRequestWithItemid:(NSString *)cid size:(NSUInteger)size key:(NSString *)key page:(NSUInteger)page loadMore:(BOOL)loadMore
{
    ...
    [self.httpRequestOperationManager POST:kGetCommentByItemIdURL parameters:[HSPublic apiPostParas:parametersDic] success:^(AFHTTPRequestOperation *operation, id responseObject) {
...
- (void)commentImgListRequestWithItemid:(NSString *)cid size:(NSUInteger)size key:(NSString *)key page:(NSUInteger)page loadMore:(BOOL)loadMore
{
    ...
    [self.httpRequestOperationManager POST:kGetCommentHasImgByItemIdURL parameters:[HSPublic apiPostParas:parametersDic] success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"JSON: %@/n %@", responseObject,[HSPublic dictionaryToJson:parametersDic]);
...
- (void)commentInfoListRequestWithItemid:(NSString *)cid size:(NSUInteger)size key:(NSString *)key page:(NSUInteger)page
{
    ...
    [self.httpRequestOperationManager POST:kGetCommentInfoURL parameters:[HSPublic apiPostParas:parametersDic] success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"JSON: %@/n %@", responseObject,[HSPublic dictionaryToJson:parametersDic]);
