...
- (void)addressRequestWithUid:(NSString *)uid sessionCode:(NSString *)sessionCode
{
    ...
    [self.httpRequestOperationManager POST:kGetAddressURL parameters:[HSPublic apiPostParas:parametersDic] success:^(AFHTTPRequestOperation *operation, id responseObject) { /// 失败
        [self hiddenMsg];
