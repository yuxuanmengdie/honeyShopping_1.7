...
- (void)sanpinTypeRequest:(int)type key:(NSString *)key
{
    ...
    [self.httpRequestOperationManager POST:kGetSpybByTypeURL parameters:[HSPublic apiPostParas:parametersDic] success:^(AFHTTPRequestOperation *operation, id responseObject) {
