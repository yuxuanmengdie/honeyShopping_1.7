...
- (void)registerRequest:(NSString *)phone password:(NSString *)passWord
{
    ...
    [self.httpRequestOperationManager POST:kRegisterURL parameters:[HSPublic apiPostParas:parametersDic] success:^(AFHTTPRequestOperation *operation, id responseObject) { /// 失败
...
- (void)FindPWRequest:(NSString *)phone password:(NSString *)passWord
{
    ...
    [self.httpRequestOperationManager POST:kSetPasswordURL parameters:[HSPublic apiPostParas:parametersDic] success:^(AFHTTPRequestOperation *operation, id responseObject) { /// 失败
        NSLog(@"success\n%@",operation.responseString);
...
- (void)sendCaptchas:(NSString *)phone
{
    ...
    [self.httpRequestOperationManager POST:kGetVerifyCodeURL parameters:[HSPublic apiPostParas:parametersDic] success:^(AFHTTPRequestOperation *operation, id responseObject) { /// 失败
...
- (void)vefiryCodeWithPhone:(NSString *)phone code:(NSString *)code
{
    ...
    [self.httpRequestOperationManager POST:kVerifyCodeURL parameters:[HSPublic apiPostParas:parametersDic] success:^(AFHTTPRequestOperation *operation, id responseObject) { /// 失败
        NSLog(@"success\n%@",operation.responseString);
